...
uwsgi --http 0.0.0.0:8080 --http-keepalive --add-header "Connection: keep-alive" --pyargv "--debug" --module petclinic.main --callable app --no-site --pythonpath=/usr/local/lib/python3.5 --pythonpath=/usr/local/lib/python3.5/site-packages --processes 3 --buffer-size 8192 --enable-threads 2>&1 > nohup.out
